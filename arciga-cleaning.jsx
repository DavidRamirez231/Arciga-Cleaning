...
export default function ArcigaCleaning() {
  ...
  const services = [
    { icon: Home, title: 'Standard Clean', desc: 'Perfect for regular maintenance. Dusting, vacuuming, mopping, and bathroom sanitization.', price: 'From $120' },
    { icon: Sparkles, title: 'Deep Clean', desc: 'Thorough top-to-bottom cleaning. Inside appliances, baseboards, and hard-to-reach areas.', price: 'From $200' },
    { icon: Clock, title: 'Move In/Out', desc: 'Get your deposit back or start fresh. Complete cleaning for transitions.', price: 'From $250' },
  ...
  const faqs = [
    { q: 'What areas do you serve?', a: 'We proudly serve Long Beach and surrounding areas including Belmont Shore, Bixby Knolls, Naples, Signal Hill, and Lakewood.' },
    ...
    { q: 'How do I pay?', a: 'We accept all major credit cards, Venmo, Zelle, and cash. Payment is due upon completion of service.' },
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, i) => (
              <div 
                key={i}
                className={`hover-lift bg-gradient-to-br from-gray-50 to-white p-8 rounded-2xl border border-gray-100 ${isVisible.testimonials ? 'animate-slide-up' : 'opacity-0'}`}
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-2xl">
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              ...
              <div className="text-left">
                ...
                <select className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 outline-none transition-all bg-white">
            ...
            <button className="btn-glow w-full bg-orange-500 hover:bg-orange-600 text-white py-4 rounded-xl font-semibold text-lg shadow-xl shadow-orange-500/30">
          ...
          <div className="grid md:grid-cols-3 gap-12 mb-12">
            ...
            <div>
              ...
              <div className="space-y-3">
                <a href="tel:+15625550123" className="flex items-center gap-3 text-gray-400 hover:text-teal-400 transition-colors">
                  <Phone className="w-5 h-5" />
                  (562) 555-0123
                </a>
                <a href="mailto:hello@arcigacleaning.com" className="flex items-center gap-3 text-gray-400 hover:text-teal-400 transition-colors">
                  <Mail className="w-5 h-5" />
                  hello@arcigacleaning.com
                </a>
